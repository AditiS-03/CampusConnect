...
export default function Login() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      await loginWithGoogle(); // will redirect, so no navigate needed
    } catch (err) {
      setError('Google sign-in failed. Check Supabase OAuth config.');
      setLoading(false);
    }
  };
    ...
    <div style={{
      ...
      <div style={{ width:'100%', maxWidth:420 }} className="animate-fade-in">
        ...
        <div className="card">
          ...
          <button onClick={handleGoogle} disabled={loading} className="btn btn-secondary" style={{ width:'100%', justifyContent:'center', gap:10 }}>
